...
class KinoKradHome extends React.Component {
    ...
    getSimpleData(){
        let f1 = {
            ...
            des: "Для Харпер отдых в поместье с живописными пейзажами и неимоверно высокими счетами не " +
              "является большой проблемой. Это все в порядке вещей. Главная героиня фильма «Род мужской» " +
              "оказалась в небольшой деревушке всего лишь в четырех часах от Лондона."

            // id: Date.now(),
            // name: "Базз Лайтер (2022)",
            // imgUrl: "https://s.kinokrad.co/uploads/img/tb/d93a6b6b554dd8a6f2dc30f59fc79cda.jpeg",
            // des: "Нередко малыши желают быть супер героями. Они стремятся спасать мир от злодеев и захватчиков. " +
            //   "В своих снах и мечтаниях они наделены сверхъестественными способностями, умеют метать молнии,..."
        }
        const oldState = this.state
        oldState.items[0] = f1
